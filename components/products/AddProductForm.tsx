                    ...
                    <div className="lg:col-span-3 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input required type="text" value={name} onChange={(e) => handleNameChange(e.target.value)} placeholder="e.g. Twin Set - Royal Blue" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Brand</label>
                                <input type="text" value={brand} onChange={(e) => setBrand(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Slug</label>
                                <input required type="text" value={slug} onChange={(e) => setSlug(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 font-mono text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Category</label>
                                <select required value={categoryId} onChange={(e) => setCategoryId(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 appearance-none text-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div className="space-y-2">
                                ...
                                <input required type="text" value={sku} onChange={(e) => { setSku(e.target.value); autoGeneratedSkuRef.current = null; }} placeholder="AY-XXXX" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            ...
                            <div className="space-y-2">
                                ...
                                <input type="text" value={barcode} onChange={(e) => setBarcode(e.target.value)} placeholder="000000000000" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Section</label>
                                <input type="number" value={section} onChange={(e) => setSection(e.target.value)} placeholder="0" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Status</label>
                                <select value={status} onChange={(e) => setStatus(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 appearance-none text-sm">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="space-y-2">
                                ...
                                <input required type="number" value={price} onChange={(e) => setPrice(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Original Price</label>
                                <input type="number" value={originalPrice} onChange={(e) => setOriginalPrice(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Currency</label>
                                <input type="text" value={currency} onChange={(e) => setCurrency(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Stock Quantity</label>
                                <input required type="number" value={stockQuantity} onChange={(e) => setStockQuantity(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Low Stock Threshold</label>
                                <input type="number" value={lowStockThreshold} onChange={(e) => setLowStockThreshold(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 border-b border-gray-50 pb-6">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        <div className="space-y-2">
                            ...
                            <textarea rows={2} value={shortDescription} onChange={(e) => setShortDescription(e.target.value)} placeholder="Catchy summary..." className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 resize-none text-sm" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Long Description</label>
                            <textarea required rows={4} value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Full product story..." className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 resize-none text-sm" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Video URL (YouTube/Vimeo)</label>
                            <input type="url" value={videoUrl} onChange={(e) => setVideoUrl(e.target.value)} placeholder="https://..." className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                        </div>
                    ...
                    <div className="lg:col-span-3 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="space-y-2">
                                ...
                                <input type="text" value={material} onChange={(e) => setMaterial(e.target.value)} placeholder="Silk, Cotton" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Occasion</label>
                                <input type="text" value={occasion} onChange={(e) => setOccasion(e.target.value)} placeholder="Wedding" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Age Range</label>
                                <input type="text" value={ageRange} onChange={(e) => setAgeRange(e.target.value)} placeholder="3-12y" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <input type="text" value={colors} onChange={(e) => setColors(e.target.value)} placeholder="Royal Blue, Pink" className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                        </div>
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-medium text-gray-900 text-sm resize-none"
                            />
                            {featuresText.trim() && (
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <input type="number" value={shippingWeight} onChange={(e) => setShippingWeight(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Dimensions Unit</label>
                                <input type="text" value={dimUnit} onChange={(e) => setDimUnit(e.target.value)} className="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-semibold text-gray-900 text-sm" />
                            </div>
                        </div>
