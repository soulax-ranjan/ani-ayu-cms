    ...
    return (
        <div className="space-y-8">
            ...
            <div key={refreshKey}>
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Organize your products into specific collections.</p>
                    </div>
                    <button
                        onClick={() => {
                            setEditing(null);
                    ...
                    >
                        ...
                        {showForm ? 'Close Editor' : 'Add Category'}
                    </button>
                </div>
                ...
                <CategoryList onEdit={(c) => { setEditing(c); setShowForm(true); window.scrollTo({ top: 0, behavior: 'smooth' }); }} />
            </div>
            ...
            <div className="fixed right-10 bottom-10 z-50 flex flex-col gap-3">
                <button
                    onClick={scrollToTop}
                    className="p-4 bg-white/80 backdrop-blur-xl shadow-2xl border border-gray-100 rounded-2xl text-gray-400 hover:text-blue-600 hover:scale-110 active:scale-95 transition-all group"
                    title="Scroll to Top"
                >
